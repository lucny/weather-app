...
// ============================================
// REACT KOMPONENTA - App
// ============================================
// Toto je funkční komponenta (Functional Component)
// Používá React Hooks pro správu stavu
  ...
  return (
    <>
      ...
      <section id="next-steps">
        {/* Dokumentace - Vite, React */}
        <div id="docs">
          {/* SVG ikona z icons.svg sprite - sprite je sada ikon v jednom souboru */}
          ...
          <ul>
            {/* Odkaz na Vite dokumentaci - target="_blank" otevře v novém tabu */}
            <li>
        ...
        <div id="social">
          ...
          <ul>
            {/* GitHub - komunitní repo a issue tracker */}
            <li>
            ...
            {/* Discord komunita - real-time chat */}
            <li>
      ...
      {/* Prázdná sekce pro prostorování */}
...
// ============================================
// EXPORT - Exportuj App komponentu
// ============================================
// default export - toto je výchozí export z tohoto souboru
// Umožňuje import jako: import App from './App.jsx'
export default App
